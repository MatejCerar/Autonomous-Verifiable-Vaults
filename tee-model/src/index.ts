...
async function handle(
    ...
    if (url.pathname === "/inputs") {
        ...
        send(res, 200, {
            ...
            xrpFeed: {
                id: env.ctx.addresses.xrpUsdFeedId,
                value: inputs.xrpFeed.value.toString(),
                decimals: inputs.xrpFeed.decimals,
                timestamp: inputs.xrpFeed.timestamp.toString(),
                oracleFallback: inputs.xrpFeed.oracleFallback,
            },
            ...
            venues: inputs.venues.map((v) => ({
                ...
                supplyApyBips: v.supplyApyBips.toString(),
                depeg: v.depeg,
